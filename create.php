...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $sql = "INSERT INTO material(fecha,usuario, numero, serial, celda, SRC, PEN, step, defecto, turno)" .
            "VALUES('$Fecha', '$Usuario', '$Numero', '$Serial', '$Celda', '$SRC', '$PEN', '$Step', '$Defecto', '$Turno')";
        $res = $connection->query($sql);

        if (!$res) {
            $errorM = "Invalid query: " . $connection->error;
            break;
        }
        ...
        <form method="post">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-2 d-grid">
                    <a class="btn btn-danger" href="principal.php" role="button">Cancel</a>
                </div>
            </div>
        </form>
    </div>
